...
#import "JKRViewerViewController.h"
#import "JKRSelectCounterButton.h"
#import "JKRImageSelectButton.h"

@interface JKRPreviewViewController () <UIPageViewControllerDataSource, UIPageViewControllerDelegate>
@property (nonatomic, readonly) NSInteger imagesCount;
/// 选择图像按钮
@property (nonatomic) JKRImageSelectButton *selectedButton;
@end

@implementation JKRPreviewViewController {
...
#pragma mark - 监听方法
- (void)clickSelectedButton:(JKRImageSelectButton *)button {
    JKRViewerViewController *viewer = _pageController.viewControllers.lastObject;
...
- (void)pageViewController:(UIPageViewController *)pageViewController willTransitionToViewControllers:(NSArray<UIViewController *> *)pendingViewControllers {
    ...
    JKRViewerViewController *viewer = (JKRViewerViewController *)pendingViewControllers.lastObject;
...
- (nullable UIViewController *)viewerControllerWithViewController:(UIViewController *)viewController isNext:(BOOL)isNext {
    ...
    JKRViewerViewController *detail = (JKRViewerViewController *)viewController;
...
- (JKRViewerViewController *)viewerControllerWithIndex:(NSInteger)index {
    JKRViewerViewController *viewer = [[JKRViewerViewController alloc] init];
